        ...
        <div className="flex flex-col h-full mt-9 mx-4">
            ...
            {carts.length > 0 ? (
                carts.map((cart, index) => (
                    <div key={cart.id} className="flex relative flex-row items-center w-full bg-[#10171F] rounded-lg mt-4 p-4">
                        <span 
                        ...
                        <div className="flex-shrink-0">
                            <img src={cart.image} className="w-24 h-24 md:w-44 md:h-44 object-cover" alt={cart.name} />
                        </div>
                        <div className="flex flex-col ml-4 w-full">
                            ...
                            <div className="mt-2 flex flex-row justify-between items-center">
                                ...
                                <span className="text-white font-uindbase text-lg md:text-2xl">Стоимость: {cart.price * cart.quantity}₽</span>
                            </div>
                        </div>
                    </div>
                ))
            ...
            <div className="flex flex-col mt-2">
                ...
                <div className="flex flex-col text-left mt-2">
                    ...
                    <br />
                    <span className="text-white font-uindbase text-lg md:text-2xl text-right">Итого: {totalAmount}₽</span>
                </div>
            </div>
        </div>
    );
